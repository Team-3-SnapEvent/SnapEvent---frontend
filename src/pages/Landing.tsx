...
const Landing = () => {
  ...
  return (
    <div>
      ...
      <Image src="/sale.jpeg" />
      <Div>
        SnapEvent는 관심 있는 브랜드를 구독하면 세일 기간에 세일 상품에 대해 알림을 보내주는 서비스를 제공합니다. 세일
        마감 직전까지 구독을 취소하지 않으면, 마감 전 날까지도 알림을 받아보실 수 있어요....!
      </Div>
      <Button
        primary={false}
      ...
      <Div>
        이 서비스를 친구에게 공유해 서로 팔로우해보세요. 서로의 구독 상품을 공유할 수 있어요! 또, 구독 서비스가 제공되지
        않는 상품의 세일 정보는 게시판을 통해 확인할 수 있어요.
      </Div>
