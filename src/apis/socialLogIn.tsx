const VITE_API_URL_SOCIAL_GOOGLE = 'http://snapevent.site/oauth2/authorization/google';
const VITE_API_URL_SOCIAL_NAVER = 'http://snapevent.site/oauth2/authorization/naver';
const VITE_API_URL_SOCIAL_KAKAO = 'http://snapevent.site/oauth2/authorization/kakao';
type fetchData= () => void;
